...
func TestMainIngestAllowsOnlyExactLoaderSymbols(t *testing.T) {
	...
	wantParameters := []string{
		...
		"ZP_WORKTREE_OPERATION_SEQUENCE", "ZP_WORKTREE_RECONCILE_REQUIRED", "ZP_WORKTREE_SHELL_ID", "ZP_WORKTREE_UNSUPPORTED",
	...
	wantFunctions := []string{
		...
		"_zp_worktree_abort_transport", "_zp_worktree_apply_transition", "_zp_worktree_budget_begin", "_zp_worktree_budget_check",
		...
		"_zp_worktree_reap_exited_pid", "_zp_worktree_resolve_shared", "_zp_worktree_resolve_shared_impl",
