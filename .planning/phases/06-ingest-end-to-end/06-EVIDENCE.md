...
- Candidate bytes and independent candidate evidence must each be fsynced and closed before the prepared journal is written/fsynced and before any namespace syscall. Candidate/evidence failure advances no journal, performs no namespace call, and leaves the target unchanged.
